...
# ---------------------------------------------------------------------------
# Standard config surface (shared ConfigPanel)
# ---------------------------------------------------------------------------
#
# The human-facing settings page (``GET /settings``) and the other UI
# pages live in :mod:`robotsix_calendar.api._ui_pages`; the JSON config
# contract below stays with the API layer.
